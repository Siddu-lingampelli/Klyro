...
describe('ToolRegistry', () => {
  it('builds the builtin registry with file tools', () => {
    ...
    expect(names).toEqual([
      'apply_patch', 'ask_user', 'dependencies', 'edit_file', 'expand_result', 'find_symbol', 'git_blame', 'git_diff', 'git_log', 'git_show', 'git_status', 'glob', 'grep',
      ...
      'shell_exec', 'spawn_agent', 'task_apply', 'task_get', 'task_list', 'task_stop', 'task_wait', 'todo_write', 'web_fetch', 'web_search', 'write_file',
    ]);
  });
